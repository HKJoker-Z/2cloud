...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'Trash', name: 'Trash', meta: { name: '垃圾箱管理' }, component: () => import('../views/manager/Trash') },
    ]
  },
  {
    path: '/front',
    ...
    children: [
      ...
      { path: 'openShare', name: 'OpenShare', meta: { name: '下载分享' }, component: () => import('../views/front/OpenShare') },
    ]
  },
